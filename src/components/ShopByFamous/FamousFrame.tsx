...
export default function FamousFrame() {
  ...
  const PathArraye: { pathImg: string; title: string }[] = [
    { pathImg: "", title: "" },
    {
      pathImg: "/picture/Famous/nike-just-do-it (2).jpg",
      title: "Kevin Durant",
    },
    { pathImg: "/picture/Famous/nike-just-do-it (3).jpg", title: "Image 3" },
    { pathImg: "/picture/Famous/nike-just-do-it (4).jpg", title: "Image 4" },
    { pathImg: "/picture/Famous/nike-just-do-it (5).jpg", title: "Image 5" },
    {
      pathImg: "/picture/Famous/nike-just-do-it (6).jpg",
      title: "Lebron James",
    },
    { pathImg: "/picture/Famous/nike-just-do-it (7).jpg", title: "Image 7" },
    { pathImg: "", title: "" },
  ];
    ...
    <div className="w-[90%] h-[660px] bg-black">
      <div className="flex w-[100%] h-[580px] bg-black space-x-6 justify-center">
        {window.innerWidth < 640 ? (
          <FamousCart
            path={PathArraye[Index - 1].pathImg}
            title={PathArraye[Index - 1].title}
            mainCart={true}
          />
        ) : (
          true
        ...
        {window.innerWidth > 640 && window.innerWidth < 1024 ? (
          <FamousCart
            path={PathArraye[Index - 2].pathImg}
            title={PathArraye[Index - 2].title}
            mainCart={false}
          />
        ) : (
          true
        ...
        {window.innerWidth > 1024 ? (
          <FamousCart
            path={PathArraye[Index].pathImg}
            title={PathArraye[Index].title}
            mainCart={false}
          />
        ) : (
          true
      ...
      <div className="w-[30%] h-[80px] bg-black flex justify-center items-center space-x-4">
        ...
        <RightArow
          Rightarrow={ShiftRight}
          Index={Index}
          pathArrayeSize={PathArraye.length}
        />
      </div>
    </div>
  );
